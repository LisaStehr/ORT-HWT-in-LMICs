...
### This is the analysis code for ORS variables. It includes three outcomes: ORT, appropriate feeding, and ORT+appropriate feeding. All analysis were done for two time periods: 2000-2009 and 2010-2021
...
knowbehav_subset <- read_dta("~/knowbehav_subset_diar.dta")
...
# check sample size per income group (leave out the distinct to geht sample size for individual n)
...
ort.data <- read_excel("~/Figure 3 country level/2010-2021/prev.latertime.country_ors.xlsx")
...
global.ci.fig <- read_excel("~/Figure 4 concentration index/Tables/global.fig.xlsx") #the values were generated in the STATA file and manually wrangled in excel to fit the format for plotting
...
### ORS
prev.perc_drinking_diar_drink_treat <- read_excel("~/Figure 3 country level/prev.country_ors.xlsx") #this is the country prevalence combined for both time periods, which I did manually in excel
...
write.csv(aarc_final, "~/Know-behav paper/aarc_final.prev.perc_drinking_diar_drink_treat.csv")

### FEEDING
prev.perc_appr_feed <- read_excel("~/Figure 3 country level/prev.country_feed.xlsx")
...
prev.perc_diar_treat_all <- read_excel("~/Figure 3 country level/prev.country_ortfeed.xlsx")
...
### ORS
prev_ors <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_drinking_diar_drink_treat.csv")
...
### FEED
prev_feed <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_appr_feed.csv")
...
### ors.feed + FEED
prev_ors.feed <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_diar_treat_all.csv")#
...
aarc_final <-read.csv("~/Figure 3 country level/aarc_final.prev.perc_diar_treat_all.csv")
ort_country_prev <- read_excel("~/Figure 3 country level/prev.country_ors.xlsx")
...
# load in aarcs and country level table
aarc_final <-read.csv("~/Figure 3 country level/aarc_final.prev.perc_appr_feed.csv")
feed_country_prev <- read_excel("~/Figure 3 country level/prev.country_feed.xlsx")
...
# load in aarcs and country level table
aarc_final <-read.csv("~/Figure 3 country level/aarc_final.prev.perc_drinking_diar_drink_treat.csv")
ortfeed_country_prev <- read_excel("~/Figure 3 country level/prev.country_ortfeed.xlsx")
...
# ORS | education
prev_later_ors_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_ors.edu.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.late.edu.xlsx")
...
# ORS | wealth
prev_later_ors_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_ors.wealth.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.late.wealth.xlsx")
...
# ORS | urban
prev_later_ors_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_ors.urban.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.late.urban.xlsx")
...
# feeding | education
prev_later_feed_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_feed.edu.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.late.edu.xlsx")
...
# feed | wealth
prev_later_feed_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_feed.wealth.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.late.wealth.xlsx")
...
# feed | urban
prev_later_feed_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_feed.urban.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.late.urban.xlsx")
...
prev_later_orsfeed_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_orsfeed.edu.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.late.edu.xlsx")
...
# orsfeed | wealth
prev_later_orsfeed_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_orsfeed.wealth.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.late.wealth.xlsx")
...
# orsfeed | urban
prev_later_orsfeed_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.later_orsfeed.urban.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.late.urban.xlsx")
...
# ORS | education
prev_early_ors_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_ors.edu.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.early.edu.xlsx")
...
# ORS | wealth
prev_early_ors_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_ors.wealth.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.early.wealth.xlsx")
...
# ORS | urban
prev_early_ors_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_ors.urban.xlsx")
concentration_index_ORS <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.ORS.early.urban.xlsx")
...
# feeding | education
prev_early_feed_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_feed.edu.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.early.edu.xlsx")
...
# feed | wealth
prev_early_feed_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_feed.wealth.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.early.wealth.xlsx")
...
# feed | urban
prev_early_feed_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_feed.urban.xlsx")
concentration_index_feed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.feed.early.urban.xlsx")
...
# ORS + feeding | education
prev_early_orsfeed_edu <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_orsfeed.edu.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.early.edu.xlsx")
...
# orsfeed | wealth
prev_early_orsfeed_wealth <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_orsfeed.wealth.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.early.wealth.xlsx")
...
# orsfeed | urban
prev_early_orsfeed_urban <- read_excel("~/Figure 4 concentration index/Tables/Prevalence by tables/prev.early_orsfeed.urban.xlsx")
concentration_index_orsfeed <- read_excel("~/Figure 4 concentration index/Tables/concentration.index.orsfeed.early.urban.xlsx")
...
# ORS
prev_figure2 <- read_excel("prev_figure2.ors.xlsx") #prepare this figure in excel, easier than in R directly
...
### FEEDING
prev_figure2 <- read_excel("prev_figure2.feed.xlsx")
...
### ORS AND FEEDING
prev_figure2 <- read_excel("prev_figure2.orsfeed.xlsx")
...
### ORS
prev.perc_drinking_diar_drink_treat <- read_excel("~/Figure 3 country level/prev.country_ors.xlsx")
prev.perc_drinking_diar_drink_treat <- prev.perc_drinking_diar_drink_treat %>% 
 filter(year > 1999 & year < 2010)
...
write.csv(aarc_final, "~/Know-behav paper/aarc_final.prev.perc_drinking_diar_drink_treat.early.csv")
...
write.csv(aarc_final, "~/Know-behav paper/aarc_final.prev.perc_appr_feed.early.csv")
...
write.csv(aarc_final, "~/Know-behav paper/aarc_final.prev.perc_diar_treat_all.early.csv")
...
### ORS
prev_ors <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_drinking_diar_drink_treat.early.csv")
prev_ors <- prev_ors %>% select(-X)
regions <-read.csv("~/Know-behav paper/regions.csv")
...
### FEED
prev_feed <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_appr_feed.early.csv")
prev_feed <- prev_feed %>% select(-X)
regions <-read.csv("~/Know-behav paper/regions.csv")
...
### ors.feed + FEED
prev_ors.feed <- read.csv("~/Figure 3 country level/aarc_final.prev.perc_diar_treat_all.early.csv")#
prev_ors.feed <- prev_ors.feed %>% select(-X)
regions <-read.csv("~/Know-behav paper/regions.csv")
...
# load in aarcs and country level table
aarc_final <-read.csv("~/Figure 3 country level/aarc_final.prev.perc_diar_treat_all.early.csv")
ort_country_prev <- read_excel("~/Figure 3 country level/prev.country_ors.xlsx")
...
# load in aarcs and country level table
aarc_final <-read.csv("~/Figure 3 country level/aarc_final.prev.perc_appr_feed.early.csv")
feed_country_prev <- read_excel("~/Figure 3 country level/prev.country_feed.xlsx")
